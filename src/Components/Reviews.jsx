...
const CarouselTestimonial = () => {
  ...
  return (
    <>
      <h2 className="text-center mt-10 mb-14 text-xl font-bold tracking-tight">
        Read trusted reviews from our customers
      </h2>
      {/*<!-- Component: Testimonial carousel --> */}
      <div className="glide-08 relative w-full mb-8">
        {/*    <!-- Slides --> */}
                  ...
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          Delightful flavors, cozy ambiance. A culinary journey
                          that left me craving more! A must-visit gem. 🍽️👌
                          #FoodieBliss
                        </p>
                      </blockquote>
                ...
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          Exquisite dining experience! From service to
                          presentation, they nailed it. Every bite was a
                          symphony of tastes. 👏🍷 #CulinaryElegance
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                        <span
